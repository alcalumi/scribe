  ...
  return createPortal(
    ...
    >
      <div
        ...
        tabIndex={-1}
        className={`flex max-h-[calc(100dvh-2rem)] w-full max-w-lg flex-col overflow-hidden rounded-xl border border-line bg-surface shadow-lg outline-none sm:max-h-[calc(100dvh-3rem)] ${className}`}
      >
        <div className="flex shrink-0 items-start justify-between gap-3 border-b border-line px-4 py-2.5">
          ...
          {dismissible && showCloseButton && (
            <button
              ...
              className="shrink-0 cursor-pointer rounded-lg border border-transparent p-1 text-ink-soft transition-colors duration-150 ease-out hover:bg-text/5 hover:text-text active:bg-text/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent/60 focus-visible:ring-offset-1 focus-visible:ring-offset-background"
            >
