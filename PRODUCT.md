...
Dictado por voz 100% local para macOS y Windows. Pulsas un atajo, hablas, y el
...
- **Trabajo a realizar**: escribir a velocidad de pensamiento sin mirar la
  herramienta. La app debe desaparecer; la landing debe enamorar en un scroll.
- **Modelo**: pago único 19 € / $19 (early access gratis en el lanzamiento).
- **Voz**: español, tuteo, cercano, sin corporativismos. Ver `brand/BRAND.md`.
- **Identidad visual**: estética «Porcelana» — porcelana casi neutra, tinta
  estilográfica, lacre para «grabando», EB Garamond + Hanken Grotesk.
  Sistema completo en `DESIGN.md`; tokens en `src/styles/theme.css`.
