; Custom NSIS template for Scribe with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\Scribe for portable
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "Scribe Portable Mode"
    FileClose $0
